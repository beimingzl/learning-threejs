...
const gengrateGalaxy = () => {
  ...
  for (let i = 0; i < params.count; i++) {
    ...
    positions[i * 3] = Math.cos(branchAngel + distance) * distance + Math.random()
    positions[i * 3 + 1] = Math.random()
    positions[i * 3 + 2] = Math.sin(branchAngel + distance) * distance + Math.random()
  }
